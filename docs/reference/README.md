...
This folder is for **reference only**. Older tasks in `index.yaml` may have an `appendix` field pointing to sections in these plans.

- **NEXT_STEPS_PLAN.md** — `../../NEXT_STEPS_PLAN.md` (in `docs/technical/`)
