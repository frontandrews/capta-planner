...
This folder documents the **Planner** task system. The **structured source of truth** lives in **`data/tasks/`** (index.yaml, details/, task-schema.json). Use it for tracking, search, and AI context across projects (e.g. primary-app, tasks-app).
